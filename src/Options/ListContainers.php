...
class ListContainers extends AbstractOptions
{
    ...
    public function include(): ?ListContainersIncludeDatasets
    {
        return $this->option("include");
    }

    public function withInclude(ListContainersIncludeDatasets $include): self
    {
        $clone = clone $this;
