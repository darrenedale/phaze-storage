...
class LeaseDuration implements IntContract, StringContract, Stringable
{
    ...
    {
        if (-1 > $seconds) {
            throw new InvalidValueException("Expected positive number of seconds, or -1 for indefinite duration, found {$seconds}");
        }
